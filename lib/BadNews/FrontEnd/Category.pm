# $Id: Category.pm 441 2006-12-11 21:32:47Z corrupt $
package BadNews::FrontEnd::Category;
...
sub handle_request {
    ...
    $fe->cgi->param(article_category    =>      $uri[1]);
    $fe->cgi->param(paged               =>      $uri[2]);

    $r->content_type('text/html');
    $r->send_http_header;
    $fe->render_page("multiple_article.tt2");
    return OK;
}

# $Id: Js.pm 441 2006-12-11 21:32:47Z corrupt $
package BadNews::FrontEnd::Js;
...
sub handle_request {
    ...
    my $js_dir = $fe->c->JAVASCRIPT_DIR ? $fe->c->JAVASCRIPT_DIR : $ENV{DOCUMENT_ROOT} . "/js";

    my $file_name = "$js_dir/" . join('/', @uri[1..$#uri]);

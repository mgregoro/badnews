# $Id: GpTest.pm 441 2006-12-11 21:32:47Z corrupt $
package BadNews::FrontEnd::GpTest;
...
sub handle_request {
    ...
    $fe->cgi->param(url_param_1         =>      $uri[1]);
    $fe->cgi->param(url_param_2         =>      $uri[2]);

    $r->content_type('text/html');
    $r->send_http_header;
    $fe->render_page("gptest.tt2");
    return OK;
}
